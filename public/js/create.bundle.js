...
(function () {
  ...
  var formValidate = function formValidate(e) {
    ...
    if (document.getElementById("board_admin_pw").value !== document.getElementById("board_admin_pw_conf").value) {
      ready = false;
    }
  ...
  var formSubmit = function formSubmit(e) {
    ...
    fetch('/board', {
      ...
      responseText.innerHTML = "<a href='/" + json._id + "'>view board</a><br/>" + "<a href='/" + json._id + "/admin'>admin dashboard</a><br/>" + "<a href='/" + json._id + "/party'>wur the party at</a>";
